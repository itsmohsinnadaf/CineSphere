...
export default function MovieGenres({ rootTitle, genres, onGenreClick }) {
  return (
    <section className="cs-left">
      <h2 className="cs-section-title">
        {rootTitle} <span className="cs-section-subtitle">Categories</span>
      </h2>
        ...
        {genres.map((g) => (
          ...
          >
            <div className="cs-big-image-wrap">
              {g.image && (
                <img src={g.image} alt={g.title} className="cs-big-image" />
              )}
